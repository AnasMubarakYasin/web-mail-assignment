<?php function signup(string $username = '', string $password = '') { ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
            ...
            <main>
                <label for="username">
                    ...
                    <div class="input-field">
                        ...
                        <input name="username" id="username" type="text" autocomplete="username" required value="<?= $username ?>">
                    </div>
                </label>
                <label for="password">
                    password
                    <div class="input-field">
                        ...
                        <input name="password" id="password" type="password" autocomplete="current-password" required value="<?= $password ?>">
                    </div>
                </label>
